...
execute as @a at @s if score @s withertheme matches 1 run title @s actionbar [{"bold":true,"color":"light_purple","text":"Now playing: "},{"bold":false,"color":"white","text":"COOL&CREATE - "},{"bold":false,"color":"white","italic":true,"text":"\"Last Brutal Sister Flandre S.\""}]
...
execute as @a at @s if score @s dragontheme matches 1 run title @s actionbar [{"bold":true,"color":"light_purple","text":"Now playing: "},{"bold":false,"color":"white","text":"Cosmograph - "},{"bold":false,"color":"white","italic":true,"text":"\"Afterglow\""}]
